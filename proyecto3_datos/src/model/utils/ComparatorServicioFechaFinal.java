...
public class ComparatorServicioFechaFinal implements ComparatorT<Servicio> {
	/**
	...
	public int compare(Servicio o1, Servicio o2)
	{
		...
		try {
			if(o1 != null && o2 != null)
			{
				comparar = form.parse(o1.getFechaHoraFinal()).compareTo(form.parse(o2.getFechaHoraFinal()));
